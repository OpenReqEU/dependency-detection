...
//    }
//
//    public ArrayList<Formatter> lda(String path, String stopWordsPath) throws Exception {
...
//	int numTopics = instances.getAlphabet().size()-1;
...
//
//	   // if ((double)Math.round(topicDistribution[topic] * 1000d) / 1000d > 0.000) {
//		out = new Formatter(new StringBuilder(), Locale.US);
//		out.format("%d\t%.3f\t", topic, topicDistribution[topic]);
//		int rank = 0;
//		while (iterator.hasNext() && rank < topicSortedWords.get(topic).size()) {
...
//	// testing.addThruPipe(new Instance(topicZeroText.toString(), null, "test
//	// instance", null));
//	//
